...
showMenu() {
    ...
    echo "                               ${Dim}•${No_Attributes} Command ${F_Red}${Bold}i${No_Attributes}: Installing the Xcode Command Line Tools.   ${Dim}•${No_Attributes}"
    echo "                               ${Dim}•${No_Attributes} Command ${F_Red}${Bold}u${No_Attributes}: Uninstalling the Xcode Command Line Tools. ${Dim}•${No_Attributes}"
    echo "${Dim}••${F_Green}${Bold}GateKeeper${No_Attributes}${Dim}•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}1${No_Attributes}:  Show GateKeeper Status.                                                                                 ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}2${No_Attributes}:  Enable GateKeeper.                                                                                      ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}3${No_Attributes}:  Disable GateKeeper. ${Bold}Note:${No_Attributes} These actions could lead to potential security and privacy issues.            ${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}4${No_Attributes}:  Remove app from GateKeeper quarantine.                                                                  ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}5${No_Attributes}:  If the app gives a warning that it is not signed, try self-signing. ${Bold}Note:${No_Attributes} Require Xcode or XcodeCLT.    ${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}6${No_Attributes}:  List apps from unknown sources you’ve approved for use.                                                 ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}7${No_Attributes}:  Restoring the Default GateKeeper Database.                                                              ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}••${F_Green}${Bold}Restart and Shutdown${No_Attributes}${Dim}•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}8${No_Attributes}:  Restart computer. ${Bold}Note:${No_Attributes} Confirmation is required for to restart.                                        ${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}9${No_Attributes}:  Shutdown computer. ${Bold}Note:${No_Attributes} Confirmation is required for to shutdown.                                      ${Dim}•${No_Attributes}"
    echo "${Dim}••${F_Green}${Bold}DNS and Firewall${No_Attributes}${Dim}•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}10${No_Attributes}: Flushes local DNS cache. ${Bold}Note:${No_Attributes} To use when there are problems with loading sites, 404 error.            ${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}11${No_Attributes}: Show Firewall information. ${Bold}Note:${No_Attributes} Block all is enabled or not, List applications and etc.                ${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}12${No_Attributes}: Firewall Enable.                                                                                        ${No_Attributes}${Dim}•${No_Attributes}"
    ...
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}19${No_Attributes}: Don't Show all File Extensions.                                                                         ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}••${F_Green}${Bold}WiFi${No_Attributes}${Dim}•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}20${No_Attributes}: Show WiFi information and Scan Wireless Networks.                                                       ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}21${No_Attributes}: WiFi Enable.                                                                                            ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}22${No_Attributes}: WiFi Disable.                                                                                           ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}23${No_Attributes}: Show WiFi Network Password.                                                                             ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}••${F_Green}${Bold}Hostname${No_Attributes}${Dim}•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}24${No_Attributes}: Show Hostname information. ${Bold}Note:${No_Attributes} Computer Name, Hostname, local Hostname NetBIOS Name and etc.          ${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}25${No_Attributes}: Setting a new Hostname. ${Bold}Note:${No_Attributes} Computer Name, Hostname, local Hostname and NetBIOS Name.                 ${Dim}•${No_Attributes}"
    echo "${Dim}••${F_Green}${Bold}Ping and Traceroute${No_Attributes}${Dim}••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}26${No_Attributes}: Ping Test IPv4.                                                                                         ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}27${No_Attributes}: Ping Test IPv6.                                                                                         ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}28${No_Attributes}: Finding Routers on Local Networks. ${Bold}Note:${No_Attributes} Default IP Address List for Wireless Routers.                  ${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}29${No_Attributes}: Traceroute Test IPv4.                                                                                   ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}30${No_Attributes}: Traceroute Test IPv6.                                                                                   ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}••${F_Green}${Bold}XXXXXXXX${No_Attributes}${Dim}••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}31${No_Attributes}: L                                                                                                       ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}32${No_Attributes}: L                                                                                                       ${No_Attributes}${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes} Command ${F_Red}${Bold}33${No_Attributes}: L                                                                                                       ${No_Attributes}${Dim}•${No_Attributes}"

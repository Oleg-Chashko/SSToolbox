...
> [!CAUTION]
> - Before creating Issues, we strongly recommend that you read the [README](https://github.com/Oleg-Chashko/SSToolbox/blob/main/README.md#installation-and-first-start-dmg-format) section.

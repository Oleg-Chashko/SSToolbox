...
showMenu() {
    ...
    echo "${Dim}•${No_Attributes}${F_Cyan} Command ${F_Red}${Bold}24${No_Attributes}: Show Local Network information                                                 ${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes}${F_Cyan} Command ${F_Red}${Bold}20${No_Attributes}: Show Wireless Networks information                                             ${Dim}•${No_Attributes}"
    ...
    echo "${Dim}•${No_Attributes}${F_Cyan} Command ${F_Red}${Bold}23${No_Attributes}: Show Wireless Network Password                                                 ${Dim}•${No_Attributes}"
    echo "${Dim}•${No_Attributes}${F_Cyan} Command ${F_Red}${Bold}25${No_Attributes}: Setting default a new Computer Name, Hostname and etc                          ${Dim}•${No_Attributes}"
